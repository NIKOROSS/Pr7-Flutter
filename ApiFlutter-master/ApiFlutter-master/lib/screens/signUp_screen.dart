...
class SignUpScreenState extends State<SignUpScreen> {
  ...
  Future<void> register() async {
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Ты опять забыл пароль и пытаешься создать новый акк?)', textAlign: TextAlign.center)));
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Color.fromARGB(179, 255, 0, 0),
      body: Center(
        child: Column(
          children: [
            Padding(
